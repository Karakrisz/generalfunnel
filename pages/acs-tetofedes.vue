...
useHead({
  title:
    'Ács- és tetőfedő munkák árak, tetőjavítás | ReBaco Kft. – Budapest és 50 km',
})
      ...
      <div class="subpage-content">
        ...
        <div class="trust-banner trust-banner--with-image">
          <div class="banner-bg-image">
            <NuxtImg
              src="/img/hero.svg"
              alt="Ács- és tetőfedő munkák Budapesten – tételes árajánlattal, megbízható kivitelezéssel – ReBaco Kft."
              class="banner-image"
              width="1200"
              height="600"
            />
          ...
          <div class="banner-content">
            ...
            <div class="hero-benefits" aria-label="Fő előnyök">
              ...
              <div class="hero-benefit-card">
                ...
                <div class="hero-benefit-text">
                  ...
                  <div class="hero-benefit-desc">
                    Precíz javítás/csere, tiszta csomópontok, korrekt átadás
                  </div>
                </div>
              </div>
            ...
            <p class="banner-value-prop">
              Ha most tetőjavításhoz vagy tetőfedéshez keres árat (beázás,
              csere, tetőszerkezet javítás, bádogos részletek), egy gyors
              egyeztetés után
        ...
        <div class="trust-module">
          ...
          <div class="trust-item">
            <div class="trust-content">
              <h4>SZAKSZERŰ TETŐMUNKA — BIZTOS MEGOLDÁS</h4>
              <p>
                Precíz javítás/fedés, gondos csomópontok, hogy ne kelljen rövid
                időn belül újra javítani.
              </p>
            </div>
          </div>
          <div class="trust-item">
        ...
        <div class="includes-section d-none">
          ...
          <div class="includes-grid">
            <div class="include-item">
              ...
              <span
                >Az ár függ a tető típusától, meredekségtől és a felület
                állapotától</span
              >
            </div>
            <div class="include-item">
              <span class="include-check">✓</span>
              <span
                >Előkészítés: bontás, alátétfólia/lécezés, állványozás sokat
                számít</span
              >
            </div>
            <div class="include-item">
              <span class="include-check">✓</span>
              <span
                >Részletek: kémény, vápák, szegélyek, bádogozás,
                ereszcsatorna</span
              >
            </div>
          </div>
          ...
          <div class="process-steps">
            <div class="process-step">
              ...
              <div class="step-content">
                ...
                <p>
                  Mi a gond (beázás/javítás/csere), milyen a tető, és mikorra
                  szeretné — pár perc alatt tisztázzuk az alapokat.
                </p>
              </div>
            </div>
            <div class="process-step">
              ...
              <div class="step-content">
                ...
                <p>
                  Megnézzük a fedést, a szerkezetet és a kritikus pontokat
                  (kémény, vápa, szegélyek, eresz, beázás nyomai).
                </p>
              </div>
            </div>
            <div class="process-step">
            ...
            <div class="process-step">
              ...
              <div class="step-content">
                ...
                <p>
                  Javítás/csere/szerkezet — megbeszélt ütemezés szerint. A végén
        ...
        <div class="includes-section">
          <h2 class="section-heading">
            Akik már minket választottak tető- és kivitelezési munkáknál
          </h2>
          <div class="includes-grid">
            <div class="include-item">
              <span class="include-check">✓</span>
        ...
        <div class="closing-cta-section d-none">
          ...
          <p class="closing-message">
            <strong
              ...
              legjobb megoldás az Ön tetőmunkájához, ezt is őszintén
              megmondjuk.</strong
            >
          </p>
          <p class="closing-message">
          ...
          <div class="choice-buttons">
            ...
            >
              ...
              <span class="choice-text"
                >Kérek gyors egyeztetést tetőmunkákról</span
              >
            </button>
            <button
            ...
            >
              ...
              <span class="choice-text">Szeretnék tételes tető ajánlatot</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="contactMethod === 'phone'" class="contact-section">
          <div class="phone-card">
            ...
            <p class="phone-card-subtitle">
              ReBaco Kft. – ács- és tetőfedő munkák Budapesten és környékén
            </p>
            ...
            <div class="phone-info">
              <p>
                <strong>Gyors egyeztetés tetőmunkákról</strong>
              </p>
              <p class="small">
                Beázás, javítás, csere – és mondjuk a következő lépést
              </p>
            </div>
            <div class="phone-benefits">
              <div class="benefit">✓ Tetőjavítás, fedés csere</div>
              <div class="benefit">✓ Tetőszerkezet javítás</div>
              ...
              <div class="form-group">
                ...
                >
                  ...
                  <option value="acs_tetofedo">
                    Ács- és tetőfedő munkák – Tetőjavítás, szerkezet, beázás
                  </option>
