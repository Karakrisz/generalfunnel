...
useHead({
  title:
    'Víz- és hőszigetelés árak, külső hőszigetelés, vízszigetelés | ReBaco Kft. – Budapest és 50 km',
})
      ...
      <div class="subpage-content">
        ...
        <div class="trust-banner trust-banner--with-image">
          <div class="banner-bg-image">
            <NuxtImg
              src="/img/hero.svg"
              alt="Víz- és hőszigetelés Budapesten – tételes árajánlattal, megbízható kivitelezéssel – ReBaco Kft."
              class="banner-image"
              width="1200"
              height="600"
            />
          ...
          <div class="banner-content">
            ...
            <div class="hero-benefits" aria-label="Fő előnyök">
              ...
              <div class="hero-benefit-card">
                ...
                <div class="hero-benefit-text">
                  ...
                  <div class="hero-benefit-desc">
                    Jól kialakított csomópontok, tartós rétegrend, tiszta átadás
                  </div>
                </div>
              </div>
            ...
            <p class="banner-value-prop">
              Ha most víz- és hőszigetelés árakat keres (külső hőszigetelés,
              vízszigetelés, beázás elleni megoldás, lábazat, pince), egy gyors
              egyeztetés után
        ...
        <div class="trust-module">
          ...
          <div class="trust-item">
            <div class="trust-content">
              <h4>SZAKSZERŰ SZIGETELÉS — TARTÓS MEGOLDÁS</h4>
              <p>
                Gondos csomópontok, precíz rétegrend — hogy a beázás és a
                hőveszteség ne jöjjön vissza.
              </p>
            </div>
          </div>
          <div class="trust-item">
        ...
        <div class="includes-section d-none">
          ...
          <div class="includes-grid">
            <div class="include-item">
              ...
              <span
                >Az ár függ a felülettől, rétegrendtől, hozzáféréstől és az
                előkészítéstől</span
              >
            </div>
            <div class="include-item">
              <span class="include-check">✓</span>
              <span
                >Külső hőszigetelésnél: ragasztás/dübelezés, hálózás, alapozás,
                vakolat — mind befolyásolja a végösszeget</span
              >
            </div>
            <div class="include-item">
              <span class="include-check">✓</span>
              <span
                >Vízszigetelésnél: csomópontok (lábazat, sarkok, áttörések),
                injektálás/kenhető szigetelés, drén — itt szoktak elszállni a
                költségek</span
              >
            </div>
          </div>
          ...
          <div class="process-steps">
            <div class="process-step">
              ...
              <div class="step-content">
                ...
                <p>
                  Mi a cél (hőveszteség csökkentés / penész / beázás), milyen az
                  épület, és mikorra szeretné — pár perc alatt tisztázzuk az
                  alapokat.
                </p>
              </div>
            </div>
            <div class="process-step">
              ...
              <div class="step-content">
                ...
                <p>
                  Megnézzük a rétegrendet, a felületeket és a kritikus pontokat
                  (lábazat, sarkok, csatlakozások, beázás nyomai, hőhidak).
                </p>
              </div>
            </div>
            <div class="process-step">
            ...
            <div class="process-step">
              ...
              <div class="step-content">
                ...
                <p>
                  Szigetelés (hő/víz) — megbeszélt ütemezés szerint. A végén
        ...
        <div class="includes-section">
          <h2 class="section-heading">
            Akik már minket választottak szigetelési és kivitelezési munkáknál
          </h2>
          <div class="includes-grid">
            <div class="include-item">
              <span class="include-check">✓</span>
        ...
        <div class="closing-cta-section d-none">
          ...
          <p class="closing-message">
            <strong
              ...
              legjobb megoldás az Ön szigeteléséhez, ezt is őszintén
              megmondjuk.</strong
            >
          </p>
          <p class="closing-message">
          ...
          <div class="choice-buttons">
            ...
            >
              ...
              <span class="choice-text"
                >Kérek gyors egyeztetést szigetelésről</span
              >
            </button>
            <button
            ...
            >
              ...
              <span class="choice-text"
                >Szeretnék tételes szigetelés ajánlatot</span
              >
            </button>
          </div>
        </div>
        ...
        <div v-if="contactMethod === 'phone'" class="contact-section">
          <div class="phone-card">
            ...
            <p class="phone-card-subtitle">
              ReBaco Kft. – víz- és hőszigetelés Budapesten és környékén
            </p>
            ...
            <div class="phone-info">
              <p>
                <strong>Gyors egyeztetés szigetelésről</strong>
              </p>
              <p class="small">
                Hőszigetelés vagy vízszigetelés – és mondjuk a következő lépést
              </p>
            </div>
            <div class="phone-benefits">
              <div class="benefit">✓ Külső hőszigetelés</div>
              <div class="benefit">
                ✓ Vízszigetelés, beázás elleni megoldások
              </div>
              ...
              <div class="form-group">
                ...
                >
                  ...
                  <option value="viz_hoszigetelesek">
                    Víz- és hőszigetelések – Külső hőszigetelés, vízszigetelés
                  </option>
