...
useHead({
  title:
    'Festés árak, glettelés, szobafestés | ReBaco Kft. – Budapest és 50 km',
})
      ...
      <div class="subpage-content">
        ...
        <div class="trust-banner trust-banner--with-image">
          <div class="banner-bg-image">
            <NuxtImg
              src="/img/hero.svg"
              alt="Festés Budapesten – tételes árajánlattal, megbízható kivitelezéssel – ReBaco Kft."
              class="banner-image"
              width="1200"
              height="600"
            />
          ...
          <div class="banner-content">
            <h1 class="main-title">
              Festés Budapesten – pontos, tételes árajánlattal
            </h1>
            ...
            <div class="hero-benefits" aria-label="Fő előnyök">
              ...
              <div class="hero-benefit-card">
                ...
                <div class="hero-benefit-text">
                  ...
                  <div class="hero-benefit-desc">
                    Szép vágások, foltmentes felületek, tiszta maszkolás és
                    átadás
                  </div>
                </div>
              </div>
            ...
            <p class="banner-value-prop">
              Ha most festés árat keres (szobafestés, glettelés, javítások,
              homlokzat), egy gyors egyeztetés után
              <strong>reális ársávot</strong> tudunk mondani — majd
              <strong>tételes</strong> ajánlatot adunk.
            </p>
            <p class="banner-value-prop">
              Célunk, hogy festésnél se legyen "majd a végén meglátjuk" — hanem
              előre egyeztetett műszaki tartalom és tiszta költségek.
            </p> -->
          </div>
        </div>
        ...
        <div class="trust-module">
          ...
          <div class="trust-item">
            <div class="trust-content">
              <h4>SZÉP, FOLTMENTES FESTÉS — TISZTA ÉLEK</h4>
              <p>
                Egyenletes felület, szép élek, igényes takarás és tiszta átadás.
              </p>
            </div>
          </div>
          <div class="trust-item">
        ...
        <div class="includes-section d-none">
          <h2 class="section-heading">Mennyibe kerül a festés?</h2>
          <div class="includes-grid">
            <div class="include-item">
              <span class="include-check">✓</span>
              <span>Az ár függ a felülettől, állapottól és a rétegrendtől</span>
            </div>
            <div class="include-item">
              <span class="include-check">✓</span>
              <span
                >Előkészítés: glettelés, javítások, csiszolás sokat számít</span
              >
            </div>
            <div class="include-item">
              <span class="include-check">✓</span>
              <span
                >Részletek: maszkolás, élek, javító sávok, foltmentesség</span
              >
            </div>
          </div>
        ...
        <div class="process-section d-none">
          <h2 class="section-heading">Hogyan dolgozunk festésnél?</h2>
          <div class="process-steps">
            <div class="process-step">
              ...
              <div class="step-content">
                ...
                <p>
                  Felület, állapot, szín/anyag, határidő — pár perc alatt
            ...
            <div class="process-step">
              ...
              <div class="step-content">
                ...
                <p>
                  Megnézzük a falak állapotát, repedéseket, korábbi rétegeket és
                  a kritikus pontokat (sarkok, élek, penészfoltok).
                </p>
              </div>
            </div>
            <div class="process-step">
            ...
            <div class="process-step">
              ...
              <div class="step-content">
                ...
                <p>
                  Takarás, előkészítés, festés — megbeszélt ütemezés szerint. A
                  végén közös átadás-átvétellel zárunk.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="includes-section">
          <h2 class="section-heading">
            Akik már minket választottak festési és kivitelezési munkáknál
          </h2>
          <div class="includes-grid">
            <div class="include-item">
              <span class="include-check">✓</span>
        ...
        <div class="closing-cta-section d-none">
          <h2 class="section-heading">Kér egy gyors, reális festés árat?</h2>
          <p class="closing-message">
            <strong
              >Az egyeztetés nem jár kötelezettséggel. Ha nem mi vagyunk a
              legjobb megoldás az Ön festéséhez, ezt is őszintén
              megmondjuk.</strong
            >
          </p>
          <p class="closing-message">
        ...
        <div class="safety-bridge">
          <p class="safety-bridge__text">
            <strong
              >Minden festés más. Az egyeztetés nem jár
              kötelezettséggel.</strong
            >
            Az egyeztetés során végigkérdezzük a részleteket (felület állapota,
            glettelés igénye, rétegrend), és őszintén megmondjuk, mi a reális
            megoldás.
          </p>
        </div>
        ...
        <div class="contact-choice">
          ...
          <div class="choice-buttons">
            ...
            >
              ...
              <span class="choice-text">Kérek gyors egyeztetést festésről</span>
            </button>
            <button
            ...
            >
              ...
              <span class="choice-text"
                >Szeretnék tételes festés ajánlatot</span
              >
            </button>
          </div>
        </div>
        ...
        <div v-if="contactMethod === 'phone'" class="contact-section">
          <div class="phone-card">
            ...
            <p class="phone-card-subtitle">
              ReBaco Kft. – festés Budapesten és környékén
            </p>
            ...
            <div class="phone-info">
              <p>
                <strong>Gyors egyeztetés festésről</strong>
              </p>
              <p class="small">
                Felület, állapot, glettelés – és mondjuk a következő lépést
              </p>
            </div>
            <div class="phone-benefits">
              <div class="benefit">✓ Beltéri festés, glettelés</div>
              <div class="benefit">✓ Homlokzat festés, javítások</div>
              ...
              <div class="form-group">
                ...
                >
                  ...
                  <option value="festes_burkolas_kartonozas">
                    Festés / glettelés – Szobafestés, javítások, homlokzat
                  </option>
