import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getRequestHost, getRequestProtocol, setHeader, getHeader, getQuery as getQuery$1, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/devalue/index.js';
import destr from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/errx/dist/index.js';
import { isVNode, toValue, version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/vue/index.mjs';
import devalue from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/pathe/dist/index.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/node_modules/@unhead/shared/dist/index.mjs';
...
const _1ZE88K5bly = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Applications/XAMPP/xamppfiles/htdocs/generalfunnel";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Kovács Balázs, ReBaco Kft. Ügyvezető. Lakások és házak felújítása, generálkivitelezés Budapesten és 50 km-es körzetében. Ajánlatkérés gyorsan, visszahívással. Telefon: +36 20 347 5029."},{"name":"format-detection","content":"telephone=no"},{"hid":"robots","name":"robots","content":"index, follow"},{"http-equiv":"Content-Security-Policy","content":"\n            default-src 'self' https: data:;\n            img-src 'self' https: http: data:;\n            font-src 'self' https: data:;\n            style-src 'self' https: 'unsafe-inline';\n            script-src 'self' https: http://www.gstatic.com 'unsafe-inline' 'unsafe-eval';\n          "}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"canonical","href":""},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Bakbak+One&family=Raleway:wght@400;500;600;700&display=swap"}],"style":[],"script":[],"noscript":[],"title":"Lakás- és házfelújítás, generálkivitelezés | ReBaco Kft. – Budapest és 50 km-es körzete","htmlAttrs":{"lang":"hu"}};
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Applications/XAMPP/xamppfiles/htdocs/generalfunnel/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/Applications/XAMPP/xamppfiles/htdocs/generalfunnel/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/generalfunnel","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/generalfunnel/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/generalfunnel/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/generalfunnel/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/generalfunnel/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _MNHNfWm6yT = defineNitroPlugin(async (nitroApp) => {
...
const _y0IwVw = defineEventHandler(async (e) => {
...
const _taQKFC = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _zB6MRo = defineEventHandler(async (e) => {
...
const _JVOcBe = defineEventHandler(async (e) => {
...
const _9dRn87 = defineEventHandler(async (e) => {
...
const _xWDq6U = lazyEventHandler(() => {
...
const _lazy_zoxQEA = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_zoxQEA, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _y0IwVw, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _taQKFC, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _zB6MRo, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _JVOcBe, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _9dRn87, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _xWDq6U, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_zoxQEA, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/generalfunnel/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
